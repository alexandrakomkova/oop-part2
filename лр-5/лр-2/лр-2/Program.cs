...
namespace лр_2
{
    ...
    public interface IObservable //объект наблюдения
    {
    ...
    public class Stock : IObservable
    {
        ...
        public void NewAppear() // сток.маркет()
        {
    ...
    [Serializable]
    public class Item : ICopy, IObserver
    {
        ...
        public Item(Producer producer, IObservable obs)
        {
            this.item_producer = producer;
            stock = obs;
        ...
        public void Update(object ob)
        {
            ...
            StateInfo sInfo = (StateInfo)ob;

            if (sInfo.newInfo == true)
               Form1.NewMessage();
           
        }
        public void StopCheckNew()
        {
